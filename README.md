...
> This is a React tutorial-based project.
...
```sh
  git clone https://github.com/Wahaj-Ali/react-todo-app.git
  cd react-todo-app
```
...
Feel free to check the [issues page](https://github.com/Wahaj-Ali/react-todo-app/issues).
...
Thanks to our friend [Hassan](https://github.com/codehass) for a his help to set up the react-app correctly.
...
This project is [MIT](https://github.com/Wahaj-Ali/react-todo-app/blob/dev/LICENSE) licensed.
